...
def create_fst_pronouns_to_i():
    fst = FST()

    # Agregar transiciones específicas para pronombres
    fst.add_transitions([
         (0, "he", 1, ["i"]),
        (0, "she", 1, ["i"]),
        (0, "it", 1, ["i"]),
    ...
    # Agregar transiciones para verbos usando el diccionario
    for input_verb, output_verb in verbs_dict.items():
        fst.add_transitions([(0, input_verb, 3, [output_verb])])

   
    fst.add_transitions([(0, None, 0, [])])

    fst.add_start_state(0)
    fst.add_final_state(0)  
    fst.add_final_state(1)  
    fst.add_final_state(2)  
...
def create_fst_pronouns_to_you():
    fst = FST()
...
def create_fst_pronouns_to_he():
    ...
    # Agregar transiciones para verbos usando el diccionario
    for input_verb, output_verb in verbs_dict.items():
        fst.add_transitions([(0, output_verb, 3, [input_verb])])
...
def create_fst_pronouns_to_she():
    fst = FST()
...
def create_fst_pronouns_to_they():
    fst = FST()
